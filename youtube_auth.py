...
class YouTubeAuthStore:
    """Local storage for YouTube OAuth user tokens."""

    def __init__(self, token_file: Optional[str] = None):
        self.project_root = os.path.dirname(os.path.abspath(__file__))
        self.token_file = token_file or os.path.join(config.CACHE_DIR, "youtube_user_token.json")
    ...
    def load(self) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"Error loading YouTube user token: {e}")
            return None
